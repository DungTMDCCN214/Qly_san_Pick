...
<html>
<head>
    <title>Thêm dịch vụ | Pickleball Manager</title>
        ...
        <div class="col-md-6 col-lg-5">
            ...
            <div class="glass-card p-4 p-md-5">
                ...
                <h3 class="text-center mb-4">
                    <i class="fas fa-concierge-bell me-2" style="color: #43e97b;"></i>
                    Thêm dịch vụ mới
                </h3>

                <!-- Thông tin hướng dẫn nhỏ -->
                <div class="info-note">
                    <i class="fas fa-info-circle me-2" style="color: #43e97b;"></i>
                    Thêm dịch vụ mới (ví dụ: cho thuê vợt, bán nước, huấn luyện...)
                </div>
                ...
                <form action="<%=request.getContextPath()%>/admin/service" method="post">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" class="form-control" 
                               placeholder="Ví dụ: Cho thuê vợt, Bán nước, Huấn luyện..." required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="price" class="form-control" 
                               placeholder="Ví dụ: 50000" min="0" required>
                        <div class="form-text text-muted">
                            * Giá tính bằng VNĐ
                        </div>
                    </div>
