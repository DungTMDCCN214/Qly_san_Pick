...
<html>
<head>
    <title>Thêm sân mới | Pickleball Manager</title>
    ...
    <div class="row justify-content-center">
        <div class="col-md-6 col-lg-5">
            ...
            <div class="glass-card p-4 p-md-5">
                ...
                <!-- Form: GIỮ NGUYÊN action="court" method="post" và tất cả name -->
                <form action="court" method="post">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" class="form-control" 
                               placeholder="Ví dụ: Sân A1, Sân VIP 1..." required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="price" class="form-control" 
                               placeholder="Ví dụ: 200000" required>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" class="form-control" rows="3" 
                                  placeholder="Mô tả thêm về sân (vị trí, tiện ích, lưu ý...)"></textarea>
                    </div>
