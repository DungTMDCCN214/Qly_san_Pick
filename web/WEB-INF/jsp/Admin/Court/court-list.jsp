...
<html>
<head>
    <title>Quản lý sân | Pickleball Manager</title>
...
<div class="container mt-2 mb-5">
    <div class="glass-card p-4 p-xl-5">
        ...
        <div class="header-gradient d-flex justify-content-between align-items-center mb-4">
            <h3 class="text-white">
                <i class="fas fa-table-tennis me-2"></i> Quản lý sân Pickleball
            </h3>
            <a href="court?action=add" class="btn btn-add-custom">
                <i class="fas fa-plus-circle me-2"></i> Thêm sân
            </a>
        </div>
                    ...
                    <%
                        if (list != null && !list.isEmpty()) {
                            for (Court c : list) {
                                ...
                                String priceDisplay = "";
                                Object priceObj = c.getPrice_per_hour();
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="court?action=delete&id=<%= c.getCourt_id() %>" 
                               ...
                               onclick="return confirm('⚠️ Bạn có chắc chắn muốn xóa sân <%= c.getCourt_name() %>?')">
